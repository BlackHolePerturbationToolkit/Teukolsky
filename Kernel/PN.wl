...
\[ScriptCapitalK]=Switch[norm,
	...
	"SasakiTagoshi",1,
	"LogFree",LogFreeFactorFreq[\[ScriptS],\[ScriptL],\[ScriptM],a,order\[CurlyEpsilon]]^-1 \[ScriptCapitalK]AmplitudeFreq["\[Nu]"][\[ScriptS],\[ScriptL],\[ScriptM],a,order\[CurlyEpsilon]]//DoABunchOfStuff
];
...
\[ScriptCapitalK]1=Switch[norm,
	"Default",SeriesData[\[Gamma], 0, {1}, 0, order\[CurlyEpsilon], 1],
	"DefaultSym",ISymmetryFactorFreq["\[Nu]"][\[ScriptS],\[ScriptL],\[ScriptM],a,order\[CurlyEpsilon]]^-1//DoABunchOfStuff,
	"SasakiTagoshi",\[ScriptCapitalK]AmplitudeFreq["\[Nu]"][\[ScriptS],\[ScriptL],\[ScriptM],a,order\[CurlyEpsilon]]//DoABunchOfStuff,
	"LogFree",LogFreeFactorFreq[\[ScriptS],\[ScriptL],\[ScriptM],a,order\[CurlyEpsilon]]//DoABunchOfStuff
];
\[ScriptCapitalK]2=Switch[norm,
...
CAmplitudeFreq["Inc",OptionsPattern[]][\[ScriptS]_,\[ScriptL]_,\[ScriptM]_,a_,order\[CurlyEpsilon]_]:=Module[{aux,aux2,coeff,repls,DoABunchOfStuff,\[CurlyEpsilon],\[Kappa],\[CurlyEpsilon]p,\[Tau],K1,K1coeff,K2coeff,K2,A,norm,nMin,nMax,GammaStuff},
\[CurlyEpsilon]=2 \[Omega] \[Gamma];
\[Kappa]=Sqrt[1-a^2];
\[CurlyEpsilon]p=(\[CurlyEpsilon]+\[Tau])/2;
\[Tau]=(-a \[ScriptM]+\[CurlyEpsilon])/\[Kappa];
...
coeff=(I*Pi*Csc[2*Pi*\[Nu]MST]*Csc[Pi*(\[ScriptS] + I*(\[CurlyEpsilon] + \[Tau]))]*Gamma[1 - \[ScriptS] - I*\[CurlyEpsilon] - I*\[Tau]])/(E^((I/2)*(2*Pi*(\[ScriptS] - I*\[CurlyEpsilon] + \[Nu]MST) + \[Kappa]*(\[CurlyEpsilon] + \[Tau])))*\[Kappa]^((I*\[Kappa]*(\[CurlyEpsilon] + \[Tau]))/(1 + \[Kappa])));
...
K2=Switch[norm,
	"Default",\[ScriptCapitalK]AmplitudeFreq["-\[Nu]-1"][\[ScriptS],\[ScriptL],\[ScriptM],a,order\[CurlyEpsilon]]//DoABunchOfStuff,
	"DefaultSym", ISymmetryFactorFreq["\[Nu]"][\[ScriptS],\[ScriptL],\[ScriptM],a,order\[CurlyEpsilon]]^-1 \[ScriptCapitalK]AmplitudeFreq["Ratio"][\[ScriptS],\[ScriptL],\[ScriptM],a,order\[CurlyEpsilon]]//DoABunchOfStuff,
	"SasakiTagoshi",\[ScriptCapitalK]AmplitudeFreq["-\[Nu]-1"][\[ScriptS],\[ScriptL],\[ScriptM],a,order\[CurlyEpsilon]]//DoABunchOfStuff
];
aux=coeff(K1coeff/K1+K2coeff/K2)//DoABunchOfStuff//DoABunchOfStuff;
aux
]


CAmplitudeFreq["Ref",OptionsPattern[]][\[ScriptS]_,\[ScriptL]_,\[ScriptM]_,a_,order\[CurlyEpsilon]_]:=Module[{aux,aux2,coeff,repls,DoABunchOfStuff,\[CurlyEpsilon],\[Kappa],\[CurlyEpsilon]p,\[Tau],K1,K1coeff,K2coeff,K2,A,norm,nMin,nMax,GammaStuff},
\[CurlyEpsilon]=2 \[Omega] \[Gamma];
\[Kappa]=Sqrt[1-a^2];
\[CurlyEpsilon]p=(\[CurlyEpsilon]+\[Tau])/2;
\[Tau]=(-a \[ScriptM]+\[CurlyEpsilon])/\[Kappa];
...
GammaStuff=(#//ExpandGamma//ExpandPolyGamma)&;
repls=MSTCoefficientsInternalFreq[\[ScriptS],\[ScriptL],\[ScriptM],a,Max[order\[CurlyEpsilon]+2,2]];
coeff=4^\[ScriptS]*E^((-I)*Pi*(\[ScriptS] - I*\[CurlyEpsilon] + \[Nu]MST) + (I/2)*\[Kappa]*(\[CurlyEpsilon] + \[Tau]))*Pi*\[Kappa]^(2*\[ScriptS] + (I*\[Kappa]*(\[CurlyEpsilon] + \[Tau]))/(1 + \[Kappa]))*Csc[2*Pi*\[Nu]MST]*Csc[Pi*(\[ScriptS] + I*(\[CurlyEpsilon] + \[Tau]))];
coeff=coeff/.repls//DoABunchOfStuff;
...
(*CAmplitudeFreq["Ref",OptionsPattern[]][\[ScriptS]_,\[ScriptL]_,\[ScriptM]_,a_,order\[CurlyEpsilon]_]:=Module[{aux,coeff,repls,DoABunchOfStuff,\[CurlyEpsilon],\[Kappa],\[CurlyEpsilon]p,\[Tau],K1,K2,\[ScriptCapitalK]2coeff,A,norm,nMin,nMax},
\[CurlyEpsilon]=2 \[Omega] \[Gamma];
\[Kappa]=Sqrt[1-a^2];
\[CurlyEpsilon]p=(\[CurlyEpsilon]+\[Tau])/2;
\[Tau]=(-a \[ScriptM]+\[CurlyEpsilon])/\[Kappa];
...
DoABunchOfStuff=(#//IgnoreExpansionParameter//SeriesTake[#,order\[CurlyEpsilon]]&)&;
repls=MSTCoefficientsInternalFreq[\[ScriptS],\[ScriptL],\[ScriptM],a,Max[order\[CurlyEpsilon]+2,2]];
aux=((-1)^(-\[ScriptS] - (I/2)*(\[CurlyEpsilon] + \[Tau]))*4^\[ScriptS]*Pi*\[Kappa]^(2*\[ScriptS] + (I*Sqrt[1 - a^2]*(\[CurlyEpsilon] + \[Tau]))/(1 + Sqrt[1 - a^2]))*aMST[n]*Csc[2*Pi*\[Nu]MST]*Csc[Pi*(\[ScriptS] + I*(\[CurlyEpsilon] + \[Tau]))]*
  ((-I)*E^(I*Pi*\[Nu]MST)*K1*Gamma[-1 - 2*n - 2*\[Nu]MST]*Gamma[-n + \[ScriptS] + I*\[CurlyEpsilon] - \[Nu]MST]*Gamma[2*(1 + n + \[Nu]MST)]*Gamma[1 + n - \[ScriptS] - I*\[CurlyEpsilon] + \[Nu]MST]*Gamma[1 + n + \[Nu]MST - I*\[Tau]]*
    Gamma[-n - \[Nu]MST + I*\[Tau]]*Sin[Pi*(\[ScriptS] - I*\[CurlyEpsilon] + \[Nu]MST)] + K2*Gamma[-n - \[ScriptS] - I*\[CurlyEpsilon] - \[Nu]MST]*Gamma[-2*(n + \[Nu]MST)]*Gamma[1 + n + \[ScriptS] + I*\[CurlyEpsilon] + \[Nu]MST]*
    Gamma[1 + 2*n + 2*\[Nu]MST]*Gamma[-n - \[Nu]MST - I*\[Tau]]*Gamma[1 + n + \[Nu]MST + I*\[Tau]]*Sin[Pi*(-\[ScriptS] + I*\[CurlyEpsilon] + \[Nu]MST)]))/
 (E^((I*a^2*\[CurlyEpsilon] + (-I + 3*Pi)*\[CurlyEpsilon]*(1 + \[Kappa]) + I*(-1 + a^2 - \[Kappa])*\[Tau] + Pi*(1 + \[Kappa])*((2*I)*\[Nu]MST + \[Tau]))/(2*(1 + \[Kappa])))*K1*K2*Gamma[-n - \[ScriptS] - I*\[CurlyEpsilon] - \[Nu]MST]*
  Gamma[-n + \[ScriptS] + I*\[CurlyEpsilon] - \[Nu]MST]*Gamma[1 + n - \[ScriptS] - I*\[CurlyEpsilon] + \[Nu]MST]*Gamma[1 + n + \[ScriptS] + I*\[CurlyEpsilon] + \[Nu]MST]*Gamma[-n - \[Nu]MST - I*\[Tau]]*Gamma[1 + n + \[Nu]MST - I*\[Tau]]*
  Gamma[-n - \[Nu]MST + I*\[Tau]]*Gamma[1 + n + \[Nu]MST + I*\[Tau]]);
 aux=(\!\(
\*UnderoverscriptBox[\(\[Sum]\), \(n = nMin\), \(nMax\)]aux\))/.repls//DoABunchOfStuff;
K1=Switch[norm,
	"Default",\[ScriptCapitalK]AmplitudeFreq["\[Nu]"][\[ScriptS],\[ScriptL],\[ScriptM],a,order\[CurlyEpsilon]]//DoABunchOfStuff,
	"DefaultSym",ISymmetryFactorFreq["\[Nu]"][\[ScriptS],\[ScriptL],\[ScriptM],a,order\[CurlyEpsilon]]^-1,
	"SasakiTagoshi",\[ScriptCapitalK]AmplitudeFreq["\[Nu]"][\[ScriptS],\[ScriptL],\[ScriptM],a,order\[CurlyEpsilon]]//DoABunchOfStuff
...
\[ScriptCapitalK]AmplitudeFreq["\[Nu]",OptionsPattern[]][\[ScriptS]_,\[ScriptL]_Integer,\[ScriptM]_,a_,order\[CurlyEpsilon]_]:=Module[{\[ScriptR]=0,ret,\[CapitalGamma]=Gamma,PH=Pochhammer,SeriesStuff,GammaStuff,order,coeff,sumUpPHCoeff,sumUp,sumDown,\[CurlyEpsilon]p,\[Tau],\[CurlyEpsilon],\[Kappa]=Sqrt[1-a^2],nMax,nMin,jump,jumpCount,repls,repls\[Nu]},
\[CurlyEpsilon]=2 \[Omega] \[Gamma];
\[CurlyEpsilon]p=(\[CurlyEpsilon]+\[Tau])/2;
\[Tau]=(-a \[ScriptM]+\[CurlyEpsilon])/\[Kappa];
...
coeff=((E^(I \[CurlyEpsilon] \[Kappa])) ((\[CurlyEpsilon] \[Kappa])^(\[ScriptS]-\[Nu]MST-\[ScriptR])) (2^-\[Nu]MST) (I^-\[ScriptR]) (\[CapitalGamma][1-\[ScriptS]-2 I \[CurlyEpsilon]p] \[CapitalGamma][\[ScriptR]+2 \[Nu]MST+2]) )/\[CapitalGamma][\[ScriptR]+\[Nu]MST+1-\[ScriptS]+I \[CurlyEpsilon]]/.repls//SeriesStuff;
nMax=order-1;
nMin=-(order+1);
sumUp=\!\(
...
\[ScriptCapitalK]AmplitudeFreq["\[Nu]",OptionsPattern[]][\[ScriptS]_,\[ScriptL]_,\[ScriptM]_,a_,order\[CurlyEpsilon]_]:=Module[{\[ScriptR]=0,ret,\[CapitalGamma]=Gamma,PH=Pochhammer,SeriesStuff,GammaStuff,order,coeff,sumUpPHCoeff,sumUp,sumDown,\[CurlyEpsilon]p,\[Tau],\[CurlyEpsilon],\[Kappa]=Sqrt[1-a^2],nMax,nMin,repls,repls\[Nu]},
\[CurlyEpsilon]=2 \[Omega] \[Gamma];
\[CurlyEpsilon]p=(\[CurlyEpsilon]+\[Tau])/2;
\[Tau]=(-a \[ScriptM]+\[CurlyEpsilon])/\[Kappa];
SeriesStuff=(#//IgnoreExpansionParameter//SeriesTake[#,order\[CurlyEpsilon]]&)&;
...
SuperscriptBox[\((\(-1\))\), \(n\)], \(\(\((\[ScriptR] - n)\)!\) PH[\[ScriptR] + 2\  \[Nu]MST + 2, n]\)] 
\*FractionBox[\(PH[\[Nu]MST + 1 + \[ScriptS] - I\  \[CurlyEpsilon], n]\), \(PH[\[Nu]MST + 1 - \[ScriptS] + I\  \[CurlyEpsilon], n]\)] /. repls\[Nu][n])\) \((aMST[n] /. repls)\)\)\)//SeriesStuff;
ret=coeff sumUp/sumDown //SeriesStuff;
ret
]


\[ScriptCapitalK]AmplitudeFreq["-\[Nu]-1",OptionsPattern[]][\[ScriptS]_,\[ScriptL]_Integer,\[ScriptM]_,a_,order\[CurlyEpsilon]_]:=Module[{\[ScriptR]=0,ret,\[CapitalGamma]=Gamma,PH=Pochhammer,order,coeff,DoABunchOfStuff,SeriesStuff,GammaStuff,sumUpPHCoeff,sumUp,sumDown,\[CurlyEpsilon]p,\[Tau],\[CurlyEpsilon],\[Kappa]=Sqrt[1-a^2],nMax,nMin,jump,jumpCount,repls,repls\[Nu]},
\[CurlyEpsilon]=2 \[Omega] \[Gamma];
\[CurlyEpsilon]p=(\[CurlyEpsilon]+\[Tau])/2;
\[Tau]=(-a \[ScriptM]+\[CurlyEpsilon])/\[Kappa];
SeriesStuff=(#//IgnoreExpansionParameter//SeriesTake[#,order\[CurlyEpsilon]]&)&;
...
repls=MSTCoefficientsInternalFreq[\[ScriptS],\[ScriptL],\[ScriptM],a,order];
repls\[Nu][n_]:=<|\[Nu]MST->(repls[\[Nu]MST]//SeriesTake[#,SeriesLength[repls[aMST[n]]]+jumpCount]&)|>;
coeff=(I^-\[ScriptR] 2^(1+\[Nu]MST) E^(I \[CurlyEpsilon] \[Kappa]) (\[CurlyEpsilon] \[Kappa])^(1-\[ScriptR]+\[ScriptS]+\[Nu]MST) (\[CapitalGamma][1-\[ScriptS]-2 I \[CurlyEpsilon]p] \[CapitalGamma][\[ScriptR]-2 \[Nu]MST]))/\[CapitalGamma][\[ScriptR]-\[ScriptS]+I \[CurlyEpsilon]-\[Nu]MST]/.repls//SeriesStuff;
nMax=order-1;
nMin=-(order+1);
sumUp=\!\(
\*UnderoverscriptBox[\(\[Sum]\), \(n = nMin\), \(-\[ScriptR]\)]\(\((
...
\[ScriptCapitalK]AmplitudeFreq["-\[Nu]-1",OptionsPattern[]][\[ScriptS]_,\[ScriptL]_,\[ScriptM]_,a_,order\[CurlyEpsilon]_]:=Module[{\[ScriptR]=0,ret,\[CapitalGamma]=Gamma,PH=Pochhammer,order,coeff,DoABunchOfStuff,SeriesStuff,sumUpPHCoeff,sumUp,sumDown,\[CurlyEpsilon]p,\[Tau],\[CurlyEpsilon],\[Kappa]=Sqrt[1-a^2],nMax,nMin,repls,repls\[Nu]},
\[CurlyEpsilon]=2 \[Omega] \[Gamma];
\[CurlyEpsilon]p=(\[CurlyEpsilon]+\[Tau])/2;
\[Tau]=(-a \[ScriptM]+\[CurlyEpsilon])/\[Kappa];
SeriesStuff=(#//IgnoreExpansionParameter//SeriesTake[#,order\[CurlyEpsilon]]&)&;
...
\[ScriptCapitalK]AmplitudeFreq["Ratio",OptionsPattern[]][\[ScriptS]_,\[ScriptL]_,\[ScriptM]_,a_,order\[CurlyEpsilon]_]:=Module[{\[ScriptR]=0,ret,\[CapitalGamma]=Gamma,PH=Pochhammer,coeff,SeriesStuff,GammaStuff,\[Kappa],order,sumUp,sumUp2,sumUpPHCoeff,sumUpPH,sumDown,sumDown2,\[CurlyEpsilon]p,\[Tau],\[CurlyEpsilon],nMax,nMin,repls,repls\[Nu]},
\[CurlyEpsilon]=2 \[Omega] \[Gamma];
\[CurlyEpsilon]p=(\[CurlyEpsilon]+\[Tau])/2;
\[Tau]=(-a \[ScriptM]+\[CurlyEpsilon])/\[Kappa];
\[Kappa]=Sqrt[1-a^2];
...
\*FractionBox[\(
\*SuperscriptBox[\((\(-1\))\), \(n\)]\  PH[1 + \[ScriptS] + I\  \[CurlyEpsilon] + \[Nu]MST, n]\  PH[1 + \[ScriptR] + 2\  \[Nu]MST, n]\  PH[1 + \[Nu]MST + I\  \[Tau], n]\), \(\(\((n - \[ScriptR])\)!\)\  PH[1 - \[ScriptS] - I\  \[CurlyEpsilon] + \[Nu]MST, n]\  PH[1 + \[Nu]MST - I\  \[Tau], n]\)] /. repls\[Nu][n])\) \((aMST[n]\  /. repls)\)\)\)//SeriesStuff;
ret=coeff  sumUp2/sumDown  sumUpPH/sumDown2//SeriesStuff;
ret
]
...
PossibleNormalizations={"Default","DefaultSym","SasakiTagoshi","UnitTransmission","LogFree"};
...
(*Echo[cUp//ChangeContext[#,"Teukolsky`PN`Private"]&,"cUp"];*)
If[OptionValue["Simplify"]&&NumericQ[\[ScriptL]],{cIn,cUp(*,deltaCoeff,source*)}={cIn,cUp(*,deltaCoeff,source*)}//SeriesCollect[#,{Inactive[SpinWeightedSpheroidalHarmonicS][__],Derivative[__][Inactive[SpinWeightedSpheroidalHarmonicS]][__]},(Simplify[#,{aVar>=0,r0Var>0,varPN>0}]&)]&];
inner=cIn Rin[r]//ChooseSide[#,r<r0Var]&;
outer=cUp Rup[r]//ChooseSide[#,r>r0Var]&;
{Btrans,Ctrans}={BAmplitude["Trans","Normalization"->OptionValue["Normalization"],"FreqRep"->False][\[ScriptS],\[ScriptL],\[ScriptM],aVar,order],CAmplitude["Trans","Normalization"->OptionValue["Normalization"],"FreqRep"->False][\[ScriptS],\[ScriptL],\[ScriptM],aVar,order]}/.\[Eta]->varPN/.\[Omega]->\[Omega]Fourier;
{cInU,cUpU}={Normal[Btrans] ChooseSide[cIn,r<r0Var],Normal[Ctrans] ChooseSide[cUp,r>r0Var]};
