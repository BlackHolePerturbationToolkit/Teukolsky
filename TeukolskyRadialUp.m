...
"TeukolskyRadialUp[a, \[Lambda], m, \[Omega], r]";

SasakiNakamuraRadialUp::usage = 
"SasakiNakamuraRadialUp[a, \[Lambda], m, \[Omega], r]";

SasakiNakamuraEquation::usage =
"SasakiNakamuraEquation[a, r, \[Omega], \[Lambda], m, {X[r], X'[r], X''[r]}]";
...
OuterBCs[a_, \[Lambda]_, m_, \[Omega]_, rout_]:=Module[{M=1,recur,k,j,rp,rm,rs,X,r,c},
...
SasakiNakamuraEquation[a_, r1_, \[Omega]_, \[Lambda]_, m_, {X_, dX_, d2X_}] := Module[{M=1,\[CapitalDelta],f,c0,c1,c2,c3,c4,\[Eta],K,V,\[Beta],\[Alpha],U1,G,F,U,r},
...
SasakiNakamuraRadialUp[a_?NumericQ, \[Lambda]_?NumericQ, m_?NumericQ, \[Omega]_?NumericQ, r1_?NumericQ] := Module[{M=1, r, rout, outBC, XUp},
 ...
 rout = 1000;
 outBC = OuterBCs[a, \[Lambda], m, \[Omega], rout];
 XUp = X/.NDSolve[{SasakiNakamuraEquation[a,r,\[Omega],\[Lambda],m,{X[r],X'[r],X''[r]}]==0, X[rout]==outBC[[1]], X'[rout]==outBC[[2]]}, X, {r, rout, 10}][[1,1]];
  
 XUp 
]
 
TeukolskyRadialUp[a_?NumericQ, \[Lambda]_?NumericQ, m_?NumericQ, \[Omega]_?NumericQ, r1_?NumericQ, Method -> "Numerical"]:=Module[{M=1, r, \[Chi]m, X, XUp, Rup, c0, c1, c2, c3 ,c4, K, \[Eta], \[CapitalDelta], \[Alpha], \[Beta], \[Chi]},
